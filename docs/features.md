...
| Footer boundary appearance | Opaque application webviews use their document color for the native backing background | Both macOS hosts failed the new fractional-height drag check before the fix and passed afterward. Native-resolution recordings contain no bright footer line; the complete window suite passed 31/31. User confirmed disappearance on 2026-09-08 | Unreleased |
